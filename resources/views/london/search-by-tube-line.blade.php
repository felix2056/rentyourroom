...
@section('title', 'Search by tube line')
...
<main id="spareroom" class="wrap wrap--main">
    <section id="london-search" class="tube-line">
    ...
    <div class="cols_12">
        <blockquote class="cols_4_first">
            <p class="quote">Put an advert on at around 11.30 in the evening, room was gone by next morning. Usual fabulous
                service from SpareRoom!</p>
            <p class="author">&#126; Gill</p>
        </blockquote>
        ...
        <blockquote class="cols_4">
            <p class="quote">The entire experience was great - putting the ad up was very simple and took no time at all. I
                was really impressed with how easy using the site was</p>
