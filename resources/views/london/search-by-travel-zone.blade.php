...
@section('title', 'Search by travel zone')
...
<main id="spareroom" class="wrap wrap--main">
    <section id="london-search" class="travel-zone">
    ...
    <div class="cols_12">
        <blockquote class="cols_4_first">
            <p class="quote">it's amazing! I've never had so many hits from an advert, and I'm an estate agent by day!
                Excellent service!</p>
            <p class="author">&#126; AM</p>
        </blockquote>
        <blockquote class="cols_4">
            <p class="quote">#ff SpareRoomUK...I can personally vouch for them being brilliant at what they do. Made my move
                to Nigeria really easy. Thanks guys :)</p>
            <p class="author">&#126; Claire B</p>
        </blockquote>
        <blockquote class="cols_4">
            <p class="quote">This is without doubt the best method I have ever found for finding a lodger other than letting
                selected friends know I have a vacancy</p>
    ...
    (function ($) {
      ...
      var londonSearch = $('#london-search'),
        ...
        pushState = function ($form, $href) {
          history.pushState({ form: $form }, null, $href);
        };
