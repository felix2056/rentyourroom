...
<main id="spareroom" class="wrap wrap--main">
    <section id="london-search" class="location">
    ...
    <div class="cols_12">
        <blockquote class="cols_4_first">
            <p class="quote">Very impressed with Spare Room. Got my initial lodger within a few weeks, then we got another
                lady in within 2 days!</p>
            <p class="author">&#126; WJ</p>
        </blockquote>
        <blockquote class="cols_4">
            <p class="quote">Guys you're amazing!!! I've looked for a flat through your website twice and both times I got
                the perfect flatshare on the very first viewing</p>
            <p class="author">&#126; Eleni </p>
        </blockquote>
        <blockquote class="cols_4">
            <p class="quote">VERY impressed by SpareRoom, the most user-friendly property-based website I've had the
                pleasure of using, clear, quick and very easy to navigate</p>
            <p class="author">&#126; Roz N</p>
        </blockquote>
    </div>
</main>
@endsection
